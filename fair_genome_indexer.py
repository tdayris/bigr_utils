...
def deploy_fair_genome_indexer(
    tag: str = "latest",
    ...
    """
    Deploy fair genome indexer pipeline from https://github.com/tdayris/fair_genome_indexer
    """
    console = Console()
    ...
    pipeline: str = "fair_genome_indexer"
    extra: str = ""
    if verbose is True:
        extra += "--verbose "
    if force is True:
    ...
    # Removing samples.csv since this pipeline doesn't need it.
